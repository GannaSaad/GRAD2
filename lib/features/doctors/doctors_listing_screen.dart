...
class Doctor {
  ...
  factory Doctor.fromEntity(UserEntity entity, int index) {
    ...
    return Doctor(
      ...
      specialty: specialty,
      bio: "Senior dental specialist dedicated to providing elite clinical care.",
      image: imagePath,
      experience: "${10 + (index % 10)} years",
      rating: (4.5 + (index % 5) / 10).toStringAsFixed(1),
      reviews: (80 + index * 5).toString(),
      clinic: entity.clinicName ?? "Dentix Specialized Clinic", // SYNCED: Use the real clinic name
